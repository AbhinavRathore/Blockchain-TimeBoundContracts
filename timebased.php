...
<body style="background-color:white">
	...
	<div class="container" id="cont">
		<h1 id="heading">In a hurry? reach us</h2>
		<br><br><br><br>
		<hr>
		<h2 id="heading2">What do you expect?</h2>
		<form method="post" action="timebased_php.php">
    
			    <div class="form-group">
				<label for="type" class="control-label" id="l">Enter Dilvery type ::</label>
				<input class="form-control" placeholder="Enter Dilvery type" type="text" id="type"  name="type" required/>
				</div>
				<div class="form-group">
				<label for="size" class="control-label" id="l">Enter delivery time::</label>
				<input class="form-control" placeholder="Enter delivery time" type="text" id="time"  name="time" required/>
				</div>
				<div class="form-group">
				<label for="storeys" class="control-label" id="l">description :</label>
				<input type="text" placeholder="description" class="form-control" id="des" name="des" required/>
				</div>
